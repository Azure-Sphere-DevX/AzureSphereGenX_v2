...
static DX_DECLARE_TIMER_HANDLER(msg_handler);

/****************************************************************************************
* Binding declarations
****************************************************************************************/

static DX_TIMER_BINDING tmr_msg = {.repeat = &(struct timespec){0, 100 * ONE_MS}, .handler = msg_handler};
...
static DX_TIMER_BINDING *timer_bindings[] = { &tmr_msg };
